...
-- Database: `db_pisys`
--
CREATE DATABASE IF NOT EXISTS `db_pisys` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_pisys`;
...
DROP TABLE IF EXISTS `tbl_clinic_info`;
...
('1', 'Doctor in Anatomy', 'lc123345', 'Caballes Clinic', 'Boac, Marinduque', '09757736873', '3', '12344566');
...
DROP TABLE IF EXISTS `tbl_dept_hospital`;
...
DROP TABLE IF EXISTS `tbl_doctor_sched`;
...
DROP TABLE IF EXISTS `tbl_emp_and_doctor`;
...
('3', 'Caballes, MD', 'Gerardo', 'O', 'Doctor', 'Male', 'Boac, Marinduque', 'Active'),
('CL2024', 'Omiping', 'Kenneth', 'Layron', 'University Lecturer', 'Male', 'Cawit, Boac, Marinduque', 'Active');
...
DROP TABLE IF EXISTS `tbl_laboratory_results`;
...
--
-- Dumping data for table `tbl_laboratory_results`
--

INSERT INTO `tbl_laboratory_results` (`lab_id`, `patient_id`, `test_date`, `test_name`, `result`, `unit`, `normal_value`, `doctor`, `hospital`, `address`, `date_time_entry`) VALUES
('4430a9dfe1578ca96e970b6da271a5a45e68a8db', '93b48656819c87792d44f1b5086c3382129eea98', '2025-04-02', 'Sugar', '1', '1', '1', '1', '1', '1', '2025-04-20 12:40:23'),
('746a76f93e87638e7d0044753c4275e51d7aa38b', 'cf6ca8939d62119de5908ca041cd8804d9922c4a', '2025-04-09', 'Sodium', '2', '2', '2', '2', '2', '2', '2025-04-19 22:35:47'),
('93d79eaa68b3fad5366bb6f338f4dff39d5d11ba', '4a2025fe85499de5896b0da0373119e4243cf547', '2025-04-03', 'Sugar', '2', '2', '2', '2', '2', '2', '2025-04-20 13:22:20');
...
DROP TABLE IF EXISTS `tbl_nhs_disease`;
...
DROP TABLE IF EXISTS `tbl_patient_complaint`;
...
('396f56c50f7099bad867e8f48487c9ee9fb51a7f', '1', 'Fair', 'wqwq', 'wqwqw', 2, 'wqwqw', '3', '469fc5f0936aa2c82fc00666501997020046d441', '2025-04-29', '00:00:00', 'Pending', '2025-04-20 17:27:45'),
('6596ea2160c7628eac127a0323b07774674cfd04', '1', 'Good', 'w', '2222', 2, '22222222', '3', '469fc5f0936aa2c82fc00666501997020046d441', '2025-04-30', '00:00:00', 'Pending', '2025-04-20 17:30:21');
...
('252ef261485152ae4d6960ca3f73e6c71131f978', 'etyet', 'tey', 'teyet', '', 'Marinduque', 'Mogpog', 'Cawit', 'yteye', 'tyeyt', '2025-04-08', 'yety', 'teye', 'Male', 'ytey', 'Single', 'Filipino', 'Catholic', 'ytryr', 'rtyr', 'yryrty', 'Cousin'),
('469fc5f0936aa2c82fc00666501997020046d441', 'aadad', 'dad', 'adad', '23', 'Marinduque', 'Boac', 'Cawit', 'dd', 'dsd', '2025-04-11', 'ewe', 'ewewe', 'Male', 'ewew', 'Single', 'Filipino', 'Catholic', 'sfsf', 'fsf', 'sfs', 'Cousin'),
('6e4ce1274ac73c9ebc23b744dcf1cb0e825e1889', '4242', '2424', '424', '424', 'Marinduque', 'Boac', '--Select Barangay--', '4242', '42424', '2025-04-09', '4242', '424', 'Male', '2424', 'Single', 'Filipino', 'Catholic', '2424', '42', '2424', 'Cousin');
...
(2, '396f56c50f7099bad867e8f48487c9ee9fb51a7f', '469fc5f0936aa2c82fc00666501997020046d441', '2025-04-20 17:27:45', '3', 'Pending'),
(3, '6596ea2160c7628eac127a0323b07774674cfd04', '469fc5f0936aa2c82fc00666501997020046d441', '2025-04-20 17:30:21', '3', 'Pending');
...
('006474da43f03643db80664e8bed77e7862f6304', '2025-04-23', '05:11:42', 'User logged in', 'Success', '123ken'),
('11a1fe5f4cae5fa2438bb011abeb0402da649e92', '2025-04-23', '03:51:01', 'User logged in', 'Success', '123ken'),
('34770f5b748546c1e0dd650cda44455bfce742bd', '2025-04-23', '05:15:55', 'User logged in', 'Success', '123ken'),
('bd1589648aab4e3bc1674c1bfb6c020d550c2ceb', '2025-04-23', '20:33:50', 'User logged in', 'Success', '123ken'),
('d15ad4d2f5897e5dfa946f68197bb04c0ce8167b', '2025-04-23', '03:53:01', 'User logged in', 'Success', '123ken');
...
--
-- Indexes for table `tbl_laboratory_results`
--
