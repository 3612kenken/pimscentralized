                        ...
                        <form action="index.html">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-12">
                                    ...
                                    <div class="form-group">
                                        <label for="last-name-column">Proficiency</label>
                                        <input type="text" id="last-name-column" class="form-control"  name="fname-column">
                                    </div>
                                </div>
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        <label for="first-name-column">Clinic Name</label>
                                        <input type="text" id="first-name-column" class="form-control"  name="lname-column">
                                    </div>
                                </div>
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        <label for="middle-name-column">Clinic Address</label>
                                        <input type="text" id="middle-name-column" class="form-control"  name="mname-column">
                                    </div>
                                </div>
                            ...
                            <table class='table mb-0' id="table1">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>N/A</td>
                                        <td>
                                            <button class="btn badge bg-success">Manage Schedule</button> 
