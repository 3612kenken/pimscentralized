...
<div class="modal text-left" id="modal_fullscreen" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							 <div class="list-group list-group-horizontal-sm mb-1 text-center" role="tablist">
								...
								<a class="list-group-item list-group-item-action active" id="list-monday-list" data-toggle="list" href="#phistory" role="tab" aria-selected="false">Patient History</a>
								...
								<div class="tab-pane fade active show" id="phistory" role="tabpanel" aria-labelledby="list-monday-list">
									...
									<div class="table-responsive">
										<table class='table mb-0' id="table1">
											...
											<?php
												$output="";
												$sql ="SELECT * FROM tbl_patient_complaint";
												...
												for($i=0;$row=$result->fetch(); $i++){
													$j=$i+1;
															...
															<td><button class="btn btn-success btn-sm" class="btn btn-sm btn-success" data-toggle="modal" data-target="#prescriptionss">Add</button></td>
															</tr>';
												}
												echo $output;
											?>
...
<div class="modal fade text-left" id="prescriptionss" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
			...
			<br>
									...
									<br>
									<a class="btn btn-primary" href="./prescriptions/presc.php?<?php echo "fullname=".$fullname."&"."license=".$license."&ptr=".$ptr; ?>">CLICK TO WRITE PRESCRIPTION</a>
								</div>
