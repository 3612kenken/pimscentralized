									...
									<div class="col-md-3 col-12">
										...
										<div class="col-md-4 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="chief_complaint" class="form-control"  name="chief_complaint"></textarea>
											</div>
                                        </div>
                                        <div class="col-md-5 col-12">
                                            <div class="form-group">
                                                <label for="history">History of Illness</label><textarea id="history" class="form-control"  name="history"></textarea>
											</div>
                                        </div>
										...
										<div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="diagnosis">Diagnosis/Treatment(To be update after doctor's treatment)</label>
										...
										<label for="diagnosis">Date & Time Complaint</label>
                                            <div class="input-group">
                                                ...
                                                <input type="date" id="date_complaint" class="form-control"  name="date_complaint">
												<input type="time" id="time_complaint" class="form-control"  name="time_complaint">
											</div>
                                        </div>
										<div class="col-md-6 col-12">
                                            <div class="form-group">
										...
										<div class="clearfix">
											<button class="btn btn-success float-right" onclick="SaveComplaint();">Save and add to Queue</button>
										</div>
						...
						<div class="tab-pane fade" id="vital-hs" role="tabpanel" aria-labelledby="list-tuesday-list">
                            ...
                            <div class="row">
								...
								<div class="col-md-4 col-12">
										...
										<div class="clearfix">
											<button class="btn btn-success float-right" onclick="SaveVitalSign();">Save Vital Sign</button>
										</div>
