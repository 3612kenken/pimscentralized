        ...
        <div id="sidebar" class='active'>
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    ...
                    <h2 class="text-primary" style="font-size:large; margin:0%;padding:0%;margin-bottom: 0%;">Patient
        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                ...
                <section class="section">
                    ...
                    <div class="row mb-4">
                        <div class="modal fade text-left" id="patient_history" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-body">
                                        <div class="list-group list-group-horizontal-sm mb-1 text-center"
                                            ...
                                            <a class="list-group-item list-group-item-action active"
                                                id="list-monday-list" data-toggle="list" href="#phistory" role="tab"
                                                aria-selected="false">History</a>
                                            <a class="list-group-item list-group-item-action" id="list-sunday-list"
                                                data-toggle="list" href="#add-record" role="tab"
                                                aria-selected="true">Patient Complain</a>
                                            <a class="list-group-item list-group-item-action" id="list-monday-list"
                                                data-toggle="list" href="#plaboratory" role="tab"
                                                aria-selected="false">Laboratory Results</a>
                                            <a class="list-group-item list-group-item-action" id="list-monday-list"
                                                data-toggle="list" href="#prescription" role="tab"
                                        ...
                                        <div class="tab-content text-justify">
                                            ...
                                            <div class="tab-pane fade" id="plaboratory" role="tabpanel"
                                            ...
                                            <div class="tab-pane fade" id="prescription" role="tabpanel"
                                                ...
                                                <br>
                                                <a class="btn btn-primary" href="./prescriptions/presc.html">CLICK TO
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><button class="btn btn-sm btn-success" data-toggle="modal"
                                                                data-target="#patient_history">Details</button></td>
                                                    </tr>
